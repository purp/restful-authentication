...
* "Extensions, Addons and Alternatives":restful-authentication/wikis/addons such as HAML templates
* "Security Design Patterns":restful-authentication/wikis/security-patterns with "snazzy diagram":http://github.com/technoweenie/restful-authentication/tree/master/notes/SecurityFramework.png
* "Authentication":restful-authentication/wikis/Authentication -- Lets a visitor identify herself (and lay claim to her corresponding Roles and measure of Trust)
* "Trust Metrics":restful-authentication/wikis/Trustification -- Confidence we can rely on the outcomes of this visitor's actions.
* "Authorization":restful-authentication/wikis/Authorization and Policy -- Based on trust and identity, what actions may this visitor perform?
* "Access Control":restful-authentication/wikis/Access Control -- How the Authorization policy is actually enforced in your code (A: hopefully without turning it into a spaghetti of if thens)
* "Rails Plugins":restful-authentication/wikis/Rails Plugins for Authentication, Trust, Authorization and Access Control
* "Tradeoffs":restful-authentication/wikis/Tradeoffs -- for the paranoid or the curious, a rundown of tradeoffs made in the code
* "CHANGELOG":restful-authentication/wikis/CHANGELOG -- Summary of changes to internals
* "TODO":restful-authentication/wikis/TODO -- Ideas for how you can help
...
The new password encryption (using a site key salt and stretching) will break existing user accounts' passwords. We recommend you use the --old-passwords option or write a migration tool and submit it as a patch. See the "Tradeoffs":restful-authentication/wikis/tradeoffs note for more information.
